...
/// <summary>
/// Overview page (was "Dashboard"). Framework-free: every UI-thread hop goes through
/// <see cref="IUiDispatcher"/> rather than System.Windows.Application.Current.Dispatcher,
/// which is what makes this class testable and portable off WPF.
/// </summary>
public partial class OverviewViewModel : ObservableObject, IDisposable
{
        ...
        OneClickOptimizer? oneClick = null)
    {
        ...
        _frameStore.Updated += (_, _) => _ui.Post(RefreshSessions);
        RefreshSessions();
    }
