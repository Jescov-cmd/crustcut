...
public partial class MainWindow : Window
{
    ...
    public MainWindow() : this(new ShellViewModel(), null, null) { }

    public MainWindow(ShellViewModel shell, OverviewViewModel? overview, OptimizeViewModel? optimize)
    {
        ...
        _shell = shell;
        _pages = new PageFactory(overview, optimize);
        DataContext = shell;
